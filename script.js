const SHEET_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSosfBP3StMyRUzwI0tUZPsLjPVH1zePCz8gZbTMOzjOvnonbmNCoy5VT46UxO0qdqb-Wm9EqTpXp8y/pub?gid=1182911633&single=true&output=csv'; // <<< REPLACE THIS!
...
function initMap(data) {
    ...
    map = L.map('advisory-map').setView([13.895476, 121.655484], 9); 
